...
function commit() {
  ...
  if (isNaN(input)) {
    ...
    $('#output').append('<p>Writing Hidden Vote to Tezos Alphanet...</p> <p>Check out the status <a href="https://alphanet.tzscan.io/KT1FfZcfsbxXgNKGHpnGWaokXXrvvW1wddGp">here</a></p>');
    // eslint-disable-next-line no-undef
    
    //call server here to write to blockchian
    var xmlHttp = new XMLHttpRequest();

    var url = hostname + "/chain?vote=" + input 
    console.log(url)
